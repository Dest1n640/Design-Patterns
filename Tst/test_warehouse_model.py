...
def test_ValidWarehouseCreated_Constructor_RestaurantOwnerAccepted():
...
def test_ValidWarehouseCreated_Constructor_ProductionShopOwnerAccepted():
...
def test_ValidationException_Constructor_InvalidPremisesRaises():
...
def test_ValidationException_Constructor_InvalidOwnerRaises():
